...
insert into program_booking(`program_num`, `booking_date`, `seat_num`, `user_id`, `viewing_date`, `viewing_time`) values (1, NOW(), 2, 1, '2023-06-08', '17:00');
insert into program_booking(`program_num`, `booking_date`, `seat_num`, `user_id`, `viewing_date`, `viewing_time`) values (1, NOW(), 2, 1, '2023-06-06', '17:00');
insert into program_booking(`program_num`, `booking_date`, `seat_num`, `user_id`, `viewing_date`, `viewing_time`) values (1, NOW(), 5, 1, '2023-06-06', '17:00');
insert into program_booking(`program_num`, `booking_date`, `seat_num`, `user_id`, `viewing_date`, `viewing_time`) values (1, NOW(), 12, 1, '2023-06-06', '17:00');
