insert into program(`end_date`, `place`, `start_date`, `target`, `title`, `type`,`seating_chart`,`seat_col`, `people_num`, `create_date`) values ('2023-06-30', '서울 성북구 아리랑로 4 (동선동4가), 3층', '2023-06-07', '제한없음', '직업특강', '오프라인', '[1,1,0,1,1,1,1,0,1,1,1,1,0,1,1]',5,12,NOW());
